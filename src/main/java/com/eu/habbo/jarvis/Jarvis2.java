...
/* Jarvis 2
   ...
   #Go Go Team Krews. Love for Harmony, Beny, Alejandro, ArpyAge, Bill, Ridge and Cronk.
 */
public class Jarvis2 extends HabboPlugin implements EventListener {
    ...
    public void onEnable() {
        ...
        if (Emulator.getConfig().getValue("discord.logging.startstopurl").equals("ADD YOUR DISCORD WEBHOOK URL HERE!")) {
            System.out.println("[" + ANSI_BLUE + "PLUGIN" + ANSI_WHITE + "] " + "JARVIS HAS DETECTED THAT YOU HAVE NOT CONFIGURED YOUR WEBHOOKS CORRECTLY. PLEASE RE-CHECK YOUR EMULATOR_CONFIG TABLE!");
        }
